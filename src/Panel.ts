...
class PropertyPanel extends egret.DisplayObjectContainer {
    ...
    showWeaponpanel() {
        if (this.weaponflag == false) {
            this.weapon = new egret.Shape();
            this.weapon.graphics.beginFill(0x000000, 0.6);
            this.weapon.graphics.drawRect(0, 0, 300, 240);
            this.weapon.graphics.endFill();
            ...
            this.tfweaponSTR.text = "附加智力：" + this.hero.equipments[0].STR;
            this.tfweaponSTR.x = 20;
            this.tfweaponSTR.y = 80;

            this.tfweaponCON.text = "附加体质：" + this.hero.equipments[0].CON;
            ...
            this.tfweaponDEX.text = "附加精神：" + this.hero.equipments[0].DEX;
